    ...
    <footer className="bg-navy text-white/80">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-white font-playfair font-semibold mb-4">Resources</h3>
            <ul className="space-y-2 font-public">
              <li><a href="#" className="hover:text-sky transition-colors">How We Empower Churches</a></li>
              <li><a href="#" className="hover:text-sky transition-colors">Church Registration</a></li>
              <li><a href="#" className="hover:text-sky transition-colors">Donation FAQ</a></li>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input 
                ...
                className="px-3 py-2 bg-navy/50 border border-white/20 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-sky font-public"
              />
              <button 
                type="submit" 
                className="bg-gold text-white font-medium py-2 px-4 rounded-md hover:bg-gold/90 transition-colors font-public"
              >
                Subscribe
              </button>
            </form>
